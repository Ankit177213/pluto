<%-- 
    Document   : upd-fligt
    Created on : Jul 2, 2019, 11:10:26 PM
    Author     : Arjun(Ajju)
--%>
...
%>
		...
		<div class="ba">
			...
			<h2 class="h1">Flight Details</h2>
				...
				<div class="up">
					<input type="submit" value="Update Flight" id="butn" name="u1" >
				</div>
<%
     if(request.getParameter("u1")!=null){
		...
		String sql="UPDATE `status` SET `fromf`='"+b+"',`date`='"+c+"',`arr`='"+d+"',`dept`='"+e+"',`tof`='"+f+"',`seats`='"+g+"',`ecoset`='"+h+"',`busset`='"+i+"',`ecosetf`='"+j+"',`bussetf`='"+k+"' WHERE fid='"+a+"'";
		int res=st.executeUpdate(sql);
		if(res!=0){%>
                
                <div class="alert alert-success">Flight Updated</div>
