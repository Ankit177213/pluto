<%-- 
    Document   : signup-page.jsp
    Created on : Jun 25, 2019, 3:54:30 PM
    Author     : Arjun(Ajju)
--%>
	...
	<div class="main">
		...
		<form method="post">
			...
			<div class="name">
				...
				<input type="email" name="e1" id="mail" placeholder="Email ID here.." required/>
			</div>
			<div class="name">
     ...
     if(request.getParameter("b1")!=null){
		...
		String sql="INSERT INTO `flight`(`name`, `dob`, `email`, `password`) VALUES('"+username+"','"+dob+"','"+email+"','"+password+"')";
